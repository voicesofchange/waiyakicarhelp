        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Waiyaki House closes that loop. Every service rendered feeds back into the community — through fair expert wages, environmental restoration, and legal and dialogue support for the people who need it most.
            </p>
          </div>
