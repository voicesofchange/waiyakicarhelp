  ...
  useEffect(() => {
    const init = async () => {
      const conv = await base44.agents.createConversation({
        agent_name: "mechanic_assistant",
        metadata: { name: "Mechanic Session" },
      });
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] flex flex-col">
      ...
      <div className="px-5 pt-12 pb-4 flex items-center gap-3">
        ...
        <div>
          <p className="text-white font-black text-base">My Assistant</p>
          <p className="text-gray-400 text-xs">Ask about your jobs & earnings</p>
        </div>
      </div>
      ...
      <div className="flex-1 bg-white rounded-t-3xl px-4 pt-5 pb-4 overflow-y-auto">
        {messages.length === 0 && (
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="font-semibold text-gray-500">Hi Prince! Ask me anything 👋</p>
            <div className="mt-4 space-y-2 text-sm text-left max-w-xs mx-auto">
              {["How much did I earn this week?", "How many jobs today?", "Which jobs are unpaid?"].map(q => (
      ...
      <div className="bg-white px-4 pb-8 pt-3 flex gap-2 border-t border-gray-100">
        <textarea
          ...
          rows={1}
          placeholder="Ask about your jobs or earnings…"
          value={input}
