...
import { MapPin, Phone, User, Car, CheckCircle, Loader2, Star, FileText, ChevronRight, ArrowLeft } from "lucide-react";
...
export default function Home() {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <MobileSelect
              ...
              className={`h-12 rounded-xl border-2 ${errors.vehicle_type ? "border-red-400" : "border-gray-100"}`}
            />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                className={`w-full pl-9 pr-3 py-3 border-2 rounded-xl text-sm resize-none focus:outline-none focus:border-amber-400 ${errors.location_description ? "border-red-400" : "border-gray-100"}`}
                rows={3}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                className="w-full pl-9 pr-3 py-3 border-2 border-gray-100 rounded-xl text-sm resize-none focus:outline-none focus:border-amber-400"
                rows={2}
          ...
          <Button
            className="w-full h-14 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-black font-black text-lg rounded-2xl shadow-lg"
            onClick={submit}
            disabled={submitting}
          >
  ...
  if (step === "tracking") {
    ...
    const isDone = activeJob?.status === "completed" || activeJob?.status === "cancelled";
    ...
    return (
      <div className="min-h-screen bg-[#0F0F0F] flex flex-col">
        ...
        <div className="px-5 pt-14 pb-8 text-center">
          ...
          <p className={`text-base font-medium ${statusInfo.color || "text-gray-300"} bg-white/10 rounded-xl px-4 py-2 inline-block`}>
            {statusInfo.text}
          </p>
        </div>
            ...
            <div className="bg-green-50 border-2 border-green-400 rounded-2xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-white border border-green-200 rounded-xl p-3 text-center">
                  ...
                  <p className="font-black text-green-700 text-base">0712 550 245</p>
                </div>
                <div className="bg-white border border-green-200 rounded-xl p-3 text-center">
                  <p className="text-xs text-gray-400 mb-0.5">Alternative</p>
                  <p className="font-black text-green-700 text-base">0116 818 759</p>
                </div>
              </div>
